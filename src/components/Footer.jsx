...
export default function Footer() {
  return (
    ...
    //                 <li className="mb-4 last:mb-0" key={link.label}>
    ...
    //             key={social.label}
    //             href={social.href}
    //             className={`text-gray-500 hover:text-gray-900 dark:hover:text-white ${index > 0 ? "ml-5" : ""
    //               }`}
...
<footer class="relative w-full bg-[#66a939] py-12">
  <div class="w-full px-8 mx-auto max-w-7xl">
    ...
    <div class="flex flex-col items-center justify-center w-full py-4 mt-12 border-t border-slate-200 md:flex-row md:justify-between">
      ...
      <div class="flex gap-4 text-text-white sm:justify-center">
        ...
        <a href="#" class="block text-white transition-opacity  hover:opacity-80">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path fill-rule="evenodd"
